        ...
        $.widget('blueimp.fileupload',
            {
                ...
                _onDone: function(result, textStatus, jqXHR, options) {
                    ...
                    if (result === "Error") {
                        ...
                        $("#thText").html("Uppladdade filer. Du kommer få en återkoppling på dina filer inom en timme.<br><span style='color:red;font-size:.8em'>OBS! För LVM (Tvångsvård enligt lagen om vård av missbrukare) sker manuell återkoppling inom 48 timmar.</span>");
