...
$.extend($.validator, {
	...
	messages: {
	    ...
	    number: "Ange en giltig siffra.",
	    digits: "Ange endats siffror.",
	    creditcard: "Ange ett giltigt kontokortsnummer.",
	    equalTo: "Upprepa din inmatning.",
	    accept: "Ange ett värde med en giltig extension.",
	    ...
	    range: $.validator.format("Ange ett värde mindre än eller lika med {0}."),
	    min: $.validator.format(" Ange ett värde strörre än eller lika med {0}.")
	},
